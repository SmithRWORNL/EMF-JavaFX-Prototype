...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Viz Object</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 *   <li>{@link prototype5.impl.VizObjectImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link prototype5.impl.VizObjectImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VizObjectImpl extends MinimalEObjectImpl.Container implements VizObject {
	/**
	...
	public void setId(int newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Prototype5Package.VIZ_OBJECT__ID, oldId, id));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Prototype5Package.VIZ_OBJECT__DESCRIPTION, oldDescription, description));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Prototype5Package.VIZ_OBJECT__NAME, oldName, name));
	}
	...
	public void copy(VizObject otherObject) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Prototype5Package.VIZ_OBJECT, null, null));
	}
