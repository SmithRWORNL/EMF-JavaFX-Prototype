...
/**
 * <!-- begin-user-doc --> A sample utility for the '<em><b>prototype5</b></em>'
 * package. <!-- end-user-doc -->
 * 
 * @generated
 */
public class Prototype5Example {
	/**
	...
	public static void main(String[] args) {
		...
		//
		resourceSet.getPackageRegistry().put(Prototype5Package.eNS_URI,
				Prototype5Package.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet
						.createResource(URI.createURI("http:///My.prototype5"));
				Face root = Prototype5Factory.eINSTANCE.createFace();
